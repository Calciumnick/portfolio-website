...
const en = {
    ...
    projects: [
        { id: 1, title: "WorkSnipers", category: "AI Platform", technologies: "Python, PostgreSQL, LLMs, Telethon", image: "/images/Drishti.png", description: "AI job-search platform: pulls vacancies from 200+ sources across 23 cities, cuts the noise with a three-tier AI filter (rules → cheap model → premium model) and delivers only relevant results by city and role. Multi-account data mining, admin analytics, running in production.", link: "" },
...
const ru: typeof en = {
    ...
    projects: [
        { id: 1, title: "WorkSnipers", category: "ИИ-платформа", technologies: "Python, PostgreSQL, LLM, Telethon", image: "/images/Drishti.png", description: "ИИ-платформа поиска работы: собирает вакансии из 200+ источников по 23 городам, отсеивает мусор трёхуровневым ИИ-фильтром (правила → дешёвая модель → премиум-модель) и присылает только релевантное по городу и роли. Мультиаккаунтный майнинг данных, админ-аналитика, работает в проде.", link: "" },
