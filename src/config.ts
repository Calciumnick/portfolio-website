...
const en = {
    ...
    projects: [
        ...
        { id: 2, title: "AutoFlow", category: "Business Automation · Private commission", technologies: "Python, REST APIs, Google Sheets, Dashboard, VPS", image: "", description: "A private client commission built to wipe out a full day of manual routine. The system connects to the client's tools by API, pulls data from several sources, cleans and enriches it with rules and AI, then delivers ready results to a live dashboard, Google Sheets and Telegram on schedule. What used to take hours of copy-paste now runs by itself and reports back — deployed on a VPS, monitored, fully hands-off.", link: "" },
